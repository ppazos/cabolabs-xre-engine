...
public class Equals extends BooleanFunction {

   public Equals(String returnName, DataType returnType)
   {
   ...
   public List<VariableInstance> execute(String sessionId)
   {
      ...
      return this.functionReturnValue( par1.getValue().equals( par2.getValue() ), re )
   }
}