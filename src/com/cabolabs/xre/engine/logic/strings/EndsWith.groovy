...
public class EndsWith extends BooleanFunction {
   ...
   public EndsWith(String returnName, DataType returnType)
   {
   ...
   public List<VariableInstance> execute(String sessionId)
   {
      ...
      println (par1.getValue() +" endsWith? "+ par2.getValue())
      
      // Todo lo anterior en una sola linea
      return this.functionReturnValue( ((String)par1.getValue()).endsWith( par2.getValue() ), re )
   }
