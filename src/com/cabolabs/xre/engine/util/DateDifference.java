...
public class DateDifference
{
    ...
    public static synchronized int numberOfSeconds(Date first, Date second)
    {
        return computeDifference( MILLISECONDS_PER_DAY, Calendar.SECOND, first, second);
    }
    ...
    public static synchronized int numberOfHours(Date first, Date second)
    {
        return computeDifference( MILLISECONDS_PER_DAY, Calendar.HOUR, first, second);
    }
    ...
    public static synchronized int numberOfMonths(Date first, Date second)
    {
        return computeDifference( MILLISECONDS_PER_DAY, Calendar.MONTH, first, second);
    }
